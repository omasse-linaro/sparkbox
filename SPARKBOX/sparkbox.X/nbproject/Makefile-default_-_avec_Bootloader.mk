...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default_-_avec_Bootloader.mk dist/${CND_CONF}/${IMAGE_TYPE}/sparkbox.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
