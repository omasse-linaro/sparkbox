...
/****************************************************************************
  ...
  ***************************************************************************/
	...
	static ROM char * ROM httpFileExtensions[HTTP_UNKNOWN+2] =
	{
	    "txt",          // HTTP_TXT
	    "htm",          // HTTP_HTM
	    "html",         // HTTP_HTML
	...
	static ROM char * ROM httpContentTypes[HTTP_UNKNOWN+2] =
	{
	    "text/plain",            		// HTTP_TXT
	    "text/html",             		// HTTP_HTM
	    "text/html",             		// HTTP_HTML
	    ...
	    "application/force-download", 	// HTTP_LOG    
	    "application/force-download", 	// HTTP_CSV    
		""							 	// HTTP_UNKNOWN
	};
